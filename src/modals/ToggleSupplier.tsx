...
const ToggleSupplier = (props: Props) => {
  ...
  return (
    <Modal
      ...
      cancelText="Discard"
    >
      <label htmlFor="inpFile" className="p-2 mb-3 d-flex">
        {file ? (
        ...
        <div className="ml-3">
          <Paragraph className="text-muted m-2 ms-3">Drag image here</Paragraph>
          <Paragraph className="text-muted m-1 ms-3">Or</Paragraph>
